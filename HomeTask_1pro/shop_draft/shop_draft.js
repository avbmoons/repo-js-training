//  Определяем массив каталога с нумерацией в имени файлов
//  Длина массива по количеству размещаемых товаров
//  (сейчас реализовано ручное размещение, дальше будем качать и размещать с сервера и считать сколько закачали товаров)
...
var clickNumber = [];
var arrCartItem = [];       //  товар в корзине
var arrCartCatalog = [];    //  массив товаров в корзине
